...
"""Structured JSON logging configuration following CESSDA guidelines.
...
- Default WARN level per CESSDA standards
"""
...
def setup_logging(level: Optional[str] = None) -> logging.Logger:
    ...
    Args:
        level: Log level (defaults to WARN per CESSDA guidelines)
    ...
    # Create logger
    logger = logging.getLogger("mcp_cessda_datasets")
